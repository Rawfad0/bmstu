...
public class SellerController
{
    ...
    private void AddOfferToStore(Store store)
    {
        try
        {
            ...
            var offerInfo = new OfferInfo(selectedProduct.Id, store.Id, price, quantity, deliveryTime);
            var offer = _offerService.Create(offerInfo);
    ...
    public void AddStore(UserSession session)
    {
        ...
        try
        {
            ...
            var createdStore = _storeService.Create(storeInfo, new SellerId(session.UserId));
