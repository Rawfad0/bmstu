...
i=1
num_TT $i
while [ -f ./func_tests/data/pos_"$TT"_in2.txt ] \
    && [ -f ./func_tests/data/pos_"$TT"_out.txt ] \
    && [ -f ./func_tests/data/pos_"$TT"_args.txt ]; do
    FILE_IN=func_tests/data/pos_"$TT"_in2.txt
...
i=1
num_TT $i
while [ -f ./func_tests/data/neg_"$TT"_in2.txt ] \
    && [ -f ./func_tests/data/neg_"$TT"_out.txt ] \
    && [ -f ./func_tests/data/neg_"$TT"_args.txt ]; do
    FILE_IN=func_tests/data/neg_"$TT"_in2.txt
