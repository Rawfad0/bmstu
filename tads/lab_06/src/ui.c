...
void print_menu(void)
{
    char options[MAX_OPT_N][2*OPT_LEN] = {"Информация о программе",
        "Считать частотный словарь из файла",
        "Вывести частотный словарь в виде дерева",
        "Найти слово в дереве и в файле",
        "Сравнение времени поиска слова в дереве и в файле",
        "Выйти"};
