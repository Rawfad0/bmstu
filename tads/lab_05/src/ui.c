...
void print_menu(void)
{
    char options[MAX_OPT_N][2*OPT_LEN] = {"Информация о программе",
        "Запустить моделирование для очереди на статическом массиве",
        "Запустить моделирование для очереди на списке",
        "Сравнение",
        "Выйти"};
...
{
    printf("\n\t* Программа предназначена для симуляции очереди.\n \
\t* Перечень доступных действий доступен в меню программы.\n");
