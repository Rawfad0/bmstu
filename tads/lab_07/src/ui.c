...
void print_menu(void)
{
    char options[MAX_OPT_N][2*OPT_LEN] = {"Информация о программе",
        ...
        "Вывести данные",
        "Найти слово (добавить)",
        "Удалить слово",
        "Сбалансировать дерево",
        "Сравнение",
        "Сравнение хеш-таблиц",
        "Запись дерева в файл res.dot",
        "Изменить максимальное количество сравнений до реструктуризации",
        "Выйти"};
...
{
    printf("\n\t* Программа предназначена для работы с двоичными \n \
\t* деревьями поиска. Дерево считывается из файла слов.\n \
