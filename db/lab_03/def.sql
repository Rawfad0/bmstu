...
CREATE OR REPLACE FUNCTION remove_user_trig_func ()
RETURNS TRIGGER
AS $$
BEGIN
...
FOR EACH ROW EXECUTE FUNCTION remove_user_trig_func();

-- Добавить 4х пользователей в таблицу
INSERT INTO users VALUES
(1001, 'Name1', 'Name1', '+7999999999', '@', '2000-01-01', '2000-01-02'),
(1002, 'Name2', 'Name2', '+7999999999', '@', '2000-01-01', '2000-01-02'),
(1003, 'Name3', 'Name3', '+7999999999', '@', '2000-01-01', '2000-01-02'),
(1004, 'Name4', 'Name4', '+7999999999', '@', '2000-01-01', '2000-01-02');
...
drop trigger delete_user_trigger on orders;
