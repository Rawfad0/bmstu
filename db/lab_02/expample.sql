...
-- Получить список категорий продуктов в описании которых присутствует слово 'pasta'
...
-- Для каждого заказанного продукта категории 1 получить его цену, среднюю цену, минимальную цену и название продукта
...
-- Получить список категорий продуктов, средняя цена которых больше общей средней цены
продуктов
...
-- Для каждой заданной группы продукта вывести среднее значение цены
