...
class LoadSolution : public BaseSolution
{
public:
    LoadSolution();
    ...
    std::shared_ptr<BaseDirector> create(const std::string& filename, const bool isbin, const bool ismatrix);


    // template<typename builder>
    //     requires std::derived_from<builder, BaseCarcasBuilder> && std::constructible_from<builder, std::shared_ptr<AbstractReader>>
    // std::shared_ptr<BaseDirector> load_from_file(const std::string& filename)
    // {
    ...
    // template<typename builder>
    //     requires std::derived_from<builder, BaseCarcasBuilder> && std::constructible_from<builder, std::shared_ptr<AbstractReader>>
    // std::shared_ptr<BaseDirector> load_from_binary(const std::string& filename)
    // {
